...
module.exports = {
    ...
    makeNonce: function () {
        var nonceLength = 32;
        return crypto.randomBytes(Math.ceil(nonceLength * 3 / 4))
    ...
    serialize: function (obj) {
        ...
        for (var p in obj)
            if (obj.hasOwnProperty(p)) {
                str.push(module.exports.fixedEncodeURIComponent(p) + "=" + module.exports.fixedEncodeURIComponent(obj[p]));
            }
        return str.join("&");
    },
    ...
    generateAuthHeader: function ({
        ...
        for (const key in unencodedHeaderObject) {
            encodedHeaderObject[module.exports.fixedEncodeURIComponent(key)] = module.exports.fixedEncodeURIComponent(unencodedHeaderObject[key]);
        }
