...
router.get('/analytica/tweet/personal/:username/engagement', async (req, res) => {
    ...
    let count = 0;
    let api_endpoint = `https://api.twitter.com/2/users/${userid}/tweets?exclude=retweets&max_results=100&media.fields=public_metrics&tweet.fields=public_metrics,created_at`;
