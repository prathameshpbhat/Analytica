...
router.get('/analytica/twitter/login/verify', async (req, res) => {
    try {
...
router.post('/analytica/twitter/login/callback', async (req, res) => {
    try {
...
router.post('/analytica/twitter/login', async (req, res) => {
    try {
